...
import com.rumbasolutions.NoSuchEntryException;

import com.rumbasolutions.model.Entry;
import com.rumbasolutions.model.impl.EntryImpl;
import com.rumbasolutions.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	@Override
	public Entry updateImpl(com.rumbasolutions.model.Entry entry)
		throws SystemException {
		entry = toUnwrappedModel(entry);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rumbasolutions.model.Entry")));

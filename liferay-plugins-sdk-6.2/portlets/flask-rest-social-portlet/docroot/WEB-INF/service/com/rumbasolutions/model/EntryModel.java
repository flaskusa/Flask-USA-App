...
/**
 * The base model interface for the Entry service. Represents a row in the &quot;social_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.rumbasolutions.model.impl.EntryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.rumbasolutions.model.impl.EntryImpl}.
 * </p>
 *
 * @author Admin
 * @see Entry
...
public interface EntryModel extends BaseModel<Entry>, GroupedModel {
	...
	@Override
	public CacheModel<com.rumbasolutions.model.Entry> toCacheModel();

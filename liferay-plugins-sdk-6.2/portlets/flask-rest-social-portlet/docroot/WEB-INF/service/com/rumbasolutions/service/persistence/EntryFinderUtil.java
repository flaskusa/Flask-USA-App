...
public class EntryFinderUtil {
	...
	public static java.util.List<com.rumbasolutions.model.Entry> findByKeywords(
		long userId, java.lang.String keywords, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder().findByKeywords(userId, keywords, start, end);
	}

	public static java.util.List<com.rumbasolutions.model.Entry> findByU_FN_EA(
	...
	public static EntryFinder getFinder() {
		if (_finder == null) {
			_finder = (EntryFinder)PortletBeanLocatorUtil.locate(com.rumbasolutions.service.ClpSerializer.getServletContextName(),

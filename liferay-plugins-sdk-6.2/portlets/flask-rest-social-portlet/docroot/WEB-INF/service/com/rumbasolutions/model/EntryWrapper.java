...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public int compareTo(com.rumbasolutions.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.rumbasolutions.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public com.rumbasolutions.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public com.rumbasolutions.model.Entry toUnescapedModel() {

...
public class FlaskMessagesModelImpl extends BaseModelImpl<FlaskMessages>
	...
	public static final String TABLE_SQL_CREATE = "create table Contacts_FlaskMessages (messageId LONG not null primary key,senderEmail VARCHAR(75) null,senderUserId LONG,senderName VARCHAR(75) null,recipients VARCHAR(75) null,message VARCHAR(255) null,sendEmail BOOLEAN,dateTime DATE null)";

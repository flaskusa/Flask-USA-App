...
/**
 * Provides the local service utility for NotificationAuditLog. This utility wraps
 * {@link com.liferay.contacts.service.impl.NotificationAuditLogLocalServiceImpl} and is the
 ...
 * @see com.liferay.contacts.service.base.NotificationAuditLogLocalServiceBaseImpl
 * @see com.liferay.contacts.service.impl.NotificationAuditLogLocalServiceImpl
 * @generated
 */
public class NotificationAuditLogLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.contacts.service.impl.NotificationAuditLogLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.contacts.model.NotificationAuditLog addNotificationAuditLog(
		...
		return getService().addNotificationAuditLog(notificationAuditLog);
	}
	...
	*/
	public static com.liferay.contacts.model.NotificationAuditLog createNotificationAuditLog(
		long notificationAuditLogId) {
		return getService().createNotificationAuditLog(notificationAuditLogId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.contacts.model.NotificationAuditLog deleteNotificationAuditLog(
		long notificationAuditLogId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteNotificationAuditLog(notificationAuditLogId);
	}
	...
	*/
	public static com.liferay.contacts.model.NotificationAuditLog deleteNotificationAuditLog(
		com.liferay.contacts.model.NotificationAuditLog notificationAuditLog)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteNotificationAuditLog(notificationAuditLog);
	}
	...
	*/
	...
	public static com.liferay.contacts.model.NotificationAuditLog fetchNotificationAuditLog(
		long notificationAuditLogId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchNotificationAuditLog(notificationAuditLogId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.contacts.model.NotificationAuditLog> getNotificationAuditLogs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getNotificationAuditLogs(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getNotificationAuditLogsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getNotificationAuditLogsCount();
	}
	...
	*/
	public static com.liferay.contacts.model.NotificationAuditLog updateNotificationAuditLog(
		com.liferay.contacts.model.NotificationAuditLog notificationAuditLog)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateNotificationAuditLog(notificationAuditLog);
	}
	...
	*/
	...
	public static NotificationAuditLogLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					NotificationAuditLogLocalService.class.getName());

			if (invokableLocalService instanceof NotificationAuditLogLocalService) {
				_service = (NotificationAuditLogLocalService)invokableLocalService;
			}
			else {
				_service = new NotificationAuditLogLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(NotificationAuditLogLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(NotificationAuditLogLocalService service) {
	}

	private static NotificationAuditLogLocalService _service;
}
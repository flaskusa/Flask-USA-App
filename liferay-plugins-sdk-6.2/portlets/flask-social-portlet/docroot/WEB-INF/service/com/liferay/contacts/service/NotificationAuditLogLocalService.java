...
/**
 * Provides the local service interface for NotificationAuditLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NotificationAuditLogLocalServiceUtil
...
public interface NotificationAuditLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NotificationAuditLogLocalServiceUtil} to access the notification audit log local service. Add custom service methods to {@link com.liferay.contacts.service.impl.NotificationAuditLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

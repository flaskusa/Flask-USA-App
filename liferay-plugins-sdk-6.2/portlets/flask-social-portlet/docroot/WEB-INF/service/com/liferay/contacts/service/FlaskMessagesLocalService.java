...
/**
 * Provides the local service interface for FlaskMessages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FlaskMessagesLocalServiceUtil
...
public interface FlaskMessagesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FlaskMessagesLocalServiceUtil} to access the flask messages local service. Add custom service methods to {@link com.liferay.contacts.service.impl.FlaskMessagesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

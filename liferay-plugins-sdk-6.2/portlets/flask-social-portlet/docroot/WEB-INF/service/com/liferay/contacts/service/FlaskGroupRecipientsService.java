...
/**
 * Provides the remote service interface for FlaskGroupRecipients. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see FlaskGroupRecipientsServiceUtil
...
public interface FlaskGroupRecipientsService extends BaseService,
	InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FlaskGroupRecipientsServiceUtil} to access the flask group recipients remote service. Add custom service methods to {@link com.liferay.contacts.service.impl.FlaskGroupRecipientsServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

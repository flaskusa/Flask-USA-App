...
/**
 * Provides the local service interface for FlaskGroupRecipients. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FlaskGroupRecipientsLocalServiceUtil
...
public interface FlaskGroupRecipientsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FlaskGroupRecipientsLocalServiceUtil} to access the flask group recipients local service. Add custom service methods to {@link com.liferay.contacts.service.impl.FlaskGroupRecipientsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
public class FlaskGroupUsersPersistenceImpl extends BasePersistenceImpl<FlaskGroupUsers>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(FlaskGroupUsersModelImpl.ENTITY_CACHE_ENABLED,
			FlaskGroupUsersModelImpl.FINDER_CACHE_ENABLED,
			FlaskGroupUsersImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUserId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(FlaskGroupUsersModelImpl.ENTITY_CACHE_ENABLED,
			FlaskGroupUsersModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<FlaskGroupUsers> findByUserId(long userId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<FlaskGroupUsers> findByUserId(long userId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public FlaskGroupUsers findByUserId_First(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchFlaskGroupUsersException, SystemException {
		FlaskGroupUsers flaskGroupUsers = fetchByUserId_First(userId,
				orderByComparator);
	 ...
	 */
	@Override
	public FlaskGroupUsers fetchByUserId_First(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		List<FlaskGroupUsers> list = findByUserId(userId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public FlaskGroupUsers findByUserId_Last(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchFlaskGroupUsersException, SystemException {
		FlaskGroupUsers flaskGroupUsers = fetchByUserId_Last(userId,
				orderByComparator);
	 ...
	 */
	@Override
	public FlaskGroupUsers fetchByUserId_Last(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<FlaskGroupUsers> list = findByUserId(userId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public FlaskGroupUsers[] findByUserId_PrevAndNext(long groupUserId,
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(session, flaskGroupUsers,
					userId, orderByComparator, true);

			array[1] = flaskGroupUsers;

			array[2] = getByUserId_PrevAndNext(session, flaskGroupUsers,
	...
	protected FlaskGroupUsers getByUserId_PrevAndNext(Session session,
		FlaskGroupUsers flaskGroupUsers, long userId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUserId(long userId) throws SystemException {
		for (FlaskGroupUsers flaskGroupUsers : findByUserId(userId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(flaskGroupUsers);
		}
	}
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "flaskGroupUsers.userId = ?";
	...
	public FlaskGroupUsers updateImpl(
		...
		if (isNew || !FlaskGroupUsersModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((flaskGroupUsersModelImpl.getColumnBitmask() &
				...
				args = new Object[] { flaskGroupUsersModelImpl.getUserId() };

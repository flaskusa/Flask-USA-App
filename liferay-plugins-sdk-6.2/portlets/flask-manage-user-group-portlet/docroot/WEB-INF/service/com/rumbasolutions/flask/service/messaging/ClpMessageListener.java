...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			FlaskGroupLocalServiceUtil.clearService();

			FlaskGroupServiceUtil.clearService();
			FlaskGroupUsersLocalServiceUtil.clearService();

			FlaskGroupUsersServiceUtil.clearService();
		}
	}
}
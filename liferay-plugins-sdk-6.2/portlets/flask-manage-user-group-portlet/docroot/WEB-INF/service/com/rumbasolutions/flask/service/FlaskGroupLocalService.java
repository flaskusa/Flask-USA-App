...
/**
 * Provides the local service interface for FlaskGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FlaskGroupLocalServiceUtil
...
public interface FlaskGroupLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FlaskGroupLocalServiceUtil} to access the flask group local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.FlaskGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

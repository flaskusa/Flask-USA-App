...
public class ClpSerializer {
	...
	public static Object translateInputUploadFile(BaseModel<?> oldModel) {
		UploadFileClp oldClpModel = (UploadFileClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getUploadFileRemoteModel();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.fl.uploadfile.NoSuchUploadFileException")) {
			return new com.fl.uploadfile.NoSuchUploadFileException();
		}
	...
	public static Object translateOutputUploadFile(BaseModel<?> oldModel) {
		...
		newModel.setUploadFileRemoteModel(oldModel);

 ...
 * @generated
 */
public class AdCustomerServiceClp implements AdCustomerService {
	public AdCustomerServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getAllCustomer";

		_methodParameterTypes3 = new String[] {  };

		_methodName4 = "getCustomer";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "addCustomer";
		...
		_methodName7 = "deleteCustomer";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "deleteCustomers";
	...
	public com.rumbasolutions.flask.model.AdCustomer getCustomer(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { customerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.rumbasolutions.flask.model.AdCustomer addCustomer(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName5,
					...
					ClpSerializer.translateInput(businessPhoneNumber),
						
					ClpSerializer.translateInput(contactPersonName),
						
					ClpSerializer.translateInput(contactPersonNumber),
	...
	public void deleteCustomer(long customerId) {
		try {
			_invokableService.invokeMethod(_methodName7,
				_methodParameterTypes7, new Object[] { customerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void deleteCustomers(java.lang.String customerList) {
		try {
			_invokableService.invokeMethod(_methodName8,
				...
				new Object[] { ClpSerializer.translateInput(customerList) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

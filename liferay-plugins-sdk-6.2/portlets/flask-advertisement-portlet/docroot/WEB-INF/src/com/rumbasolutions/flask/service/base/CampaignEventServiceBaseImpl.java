...
import com.rumbasolutions.flask.service.CampaignEventService;
...
/**
 * Provides the base implementation for the campaign event remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rumbasolutions.flask.service.impl.CampaignEventServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CampaignEventServiceBaseImpl extends BaseServiceImpl
	implements CampaignEventService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rumbasolutions.flask.service.CampaignEventServiceUtil} to access the campaign event remote service.
	 */
	...
	private CampaignEventServiceClpInvoker _clpInvoker = new CampaignEventServiceClpInvoker();
}
...
import com.rumbasolutions.flask.service.VenueSubDetailService;
...
/**
 * Provides the base implementation for the venue sub detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rumbasolutions.flask.service.impl.VenueSubDetailServiceImpl}.
 * </p>
 *
 * @author Ashutosh Rai
 ...
 * @generated
 */
public abstract class VenueSubDetailServiceBaseImpl extends BaseServiceImpl
	implements VenueSubDetailService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rumbasolutions.flask.service.VenueSubDetailServiceUtil} to access the venue sub detail remote service.
	 */
	...
	private VenueSubDetailServiceClpInvoker _clpInvoker = new VenueSubDetailServiceClpInvoker();
}
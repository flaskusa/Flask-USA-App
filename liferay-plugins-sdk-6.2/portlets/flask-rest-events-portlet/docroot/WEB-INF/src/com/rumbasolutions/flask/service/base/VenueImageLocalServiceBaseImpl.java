...
import com.rumbasolutions.flask.service.VenueImageLocalService;
...
/**
 * Provides the base implementation for the venue image local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rumbasolutions.flask.service.impl.VenueImageLocalServiceImpl}.
 * </p>
 *
 * @author Ashutosh Rai
 ...
 * @generated
 */
public abstract class VenueImageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VenueImageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rumbasolutions.flask.service.VenueImageLocalServiceUtil} to access the venue image local service.
	 */
	...
	@Override
	public VenueImage addVenueImage(VenueImage venueImage)
		throws SystemException {
		venueImage.setNew(true);

		return venueImagePersistence.update(venueImage);
	}
	 ...
	 */
	@Override
	public VenueImage createVenueImage(long venueImageId) {
		return venueImagePersistence.create(venueImageId);
	}
	...
	@Override
	public VenueImage deleteVenueImage(long venueImageId)
		throws PortalException, SystemException {
		return venueImagePersistence.remove(venueImageId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VenueImage deleteVenueImage(VenueImage venueImage)
		throws SystemException {
		return venueImagePersistence.remove(venueImage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VenueImage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return venueImagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return venueImagePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return venueImagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VenueImage fetchVenueImage(long venueImageId)
		throws SystemException {
		return venueImagePersistence.fetchByPrimaryKey(venueImageId);
	}
	 ...
	 */
	@Override
	public VenueImage getVenueImage(long venueImageId)
		throws PortalException, SystemException {
		return venueImagePersistence.findByPrimaryKey(venueImageId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return venueImagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VenueImage> getVenueImages(int start, int end)
		throws SystemException {
		return venueImagePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVenueImagesCount() throws SystemException {
		return venueImagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VenueImage updateVenueImage(VenueImage venueImage)
		throws SystemException {
		return venueImagePersistence.update(venueImage);
	}

	@Override
	public VenueImageVenueImageBlobModel getVenueImageBlobModel(
		Serializable primaryKey) throws SystemException {
		Session session = null;

		try {
			session = venueImagePersistence.openSession();

			return (com.rumbasolutions.flask.model.VenueImageVenueImageBlobModel)session.get(VenueImageVenueImageBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw venueImagePersistence.processException(e);
		}
		finally {
			venueImagePersistence.closeSession(session);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rumbasolutions.flask.model.VenueImage",
			venueImageLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = venueImagePersistence.getDataSource();
	...
	private VenueImageLocalServiceClpInvoker _clpInvoker = new VenueImageLocalServiceClpInvoker();
}
...
public class EventDetailPersistenceImpl extends BasePersistenceImpl<EventDetail>
	...
	protected EventDetail toUnwrappedModel(EventDetail eventDetail) {
		...
		eventDetailImpl.setEventDetailInfoName(eventDetail.getEventDetailInfoName());
		eventDetailImpl.setEventDetailInfoDesc(eventDetail.getEventDetailInfoDesc());
		eventDetailImpl.setEventDetailInfoComment(eventDetail.getEventDetailInfoComment());
		eventDetailImpl.setEventDetailAddressLine1(eventDetail.getEventDetailAddressLine1());
		eventDetailImpl.setEventDetailAddressLine2(eventDetail.getEventDetailAddressLine2());
		eventDetailImpl.setEventDetailInfocity(eventDetail.getEventDetailInfocity());
		eventDetailImpl.setEventDetailZip(eventDetail.getEventDetailZip());
		eventDetailImpl.setEventDetailState(eventDetail.getEventDetailState());
		eventDetailImpl.setEventDetailCountry(eventDetail.getEventDetailCountry());
		eventDetailImpl.setEventDetailLatitude(eventDetail.getEventDetailLatitude());
		eventDetailImpl.setEventDetailLongitude(eventDetail.getEventDetailLongitude());
		eventDetailImpl.setEventDetailPhone(eventDetail.getEventDetailPhone());
		eventDetailImpl.setEventDetailWebsite(eventDetail.getEventDetailWebsite());
		eventDetailImpl.setEventDetailCost(eventDetail.getEventDetailCost());

...
import com.rumbasolutions.flask.service.VenueLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rumbasolutions.flask.service.impl.VenueLocalServiceImpl}.
 * </p>
 *
 * @author Ashutosh Rai
...
public abstract class VenueLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VenueLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rumbasolutions.flask.service.VenueLocalServiceUtil} to access the venue local service.
	 */
	...
	@Override
	public Venue addVenue(Venue venue) throws SystemException {
		venue.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Venue deleteVenue(Venue venue) throws SystemException {
	...
	@Override
	public Venue fetchVenue(long venueId) throws SystemException {
	 ...
	 */
	@Override
	public Venue getVenue(long venueId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Venue> getVenues(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getVenuesCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Venue updateVenue(Venue venue) throws SystemException {
		return venuePersistence.update(venue);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rumbasolutions.flask.model.Venue",
			venueLocalService);
	}
	...
	private VenueLocalServiceClpInvoker _clpInvoker = new VenueLocalServiceClpInvoker();
}
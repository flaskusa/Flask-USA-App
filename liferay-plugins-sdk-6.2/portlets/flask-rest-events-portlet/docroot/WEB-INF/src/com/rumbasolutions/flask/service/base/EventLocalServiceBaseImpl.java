 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rumbasolutions.flask.service.impl.EventLocalServiceImpl}.
 * </p>
 *
 * @author Ashutosh Rai
...
public abstract class EventLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rumbasolutions.flask.service.EventLocalServiceUtil} to access the event local service.
	 */
	...
	@Override
	public EventEventImageBlobModel getEventImageBlobModel(
		...
		try {
			...
			return (com.rumbasolutions.flask.model.EventEventImageBlobModel)session.get(EventEventImageBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rumbasolutions.flask.model.Event",
			eventLocalService);
	}

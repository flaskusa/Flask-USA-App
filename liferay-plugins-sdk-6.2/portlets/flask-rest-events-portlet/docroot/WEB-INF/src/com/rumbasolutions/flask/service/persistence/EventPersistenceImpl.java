...
import com.rumbasolutions.flask.NoSuchEventException;
import com.rumbasolutions.flask.model.Event;
import com.rumbasolutions.flask.model.impl.EventImpl;
import com.rumbasolutions.flask.model.impl.EventModelImpl;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_VENUEID = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, EventImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_VENUEID =
		new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			...
			EventModelImpl.VENUEID_COLUMN_BITMASK |
			EventModelImpl.EVENTDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_VENUEID = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Event> findByvenueId(long venueId) throws SystemException {
	 ...
	 */
	@Override
	public List<Event> findByvenueId(long venueId, int start, int end)
	 ...
	 */
	@Override
	public Event findByvenueId_First(long venueId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		Event event = fetchByvenueId_First(venueId, orderByComparator);
	 ...
	 */
	@Override
	public Event fetchByvenueId_First(long venueId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Event> list = findByvenueId(venueId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Event findByvenueId_Last(long venueId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		Event event = fetchByvenueId_Last(venueId, orderByComparator);
	 ...
	 */
	@Override
	public Event fetchByvenueId_Last(long venueId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Event> list = findByvenueId(venueId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Event[] findByvenueId_PrevAndNext(long eventId, long venueId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		...
		try {
			...
			array[0] = getByvenueId_PrevAndNext(session, event, venueId,
					orderByComparator, true);

			array[1] = event;

			array[2] = getByvenueId_PrevAndNext(session, event, venueId,
	...
	protected Event getByvenueId_PrevAndNext(Session session, Event event,
		long venueId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByvenueId(long venueId) throws SystemException {
		for (Event event : findByvenueId(venueId, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_VENUEID_VENUEID_2 = "event.venueId = ?";
	...
	@Override
	public Event updateImpl(com.rumbasolutions.flask.model.Event event)
		throws SystemException {
		event = toUnwrappedModel(event);
		...
		if (isNew || !EventModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((eventModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { eventModelImpl.getOriginalVenueId() };
				...
				args = new Object[] { eventModelImpl.getVenueId() };
	...
	protected Event toUnwrappedModel(Event event) {
		...
		eventImpl.setCreatedDate(event.getCreatedDate());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rumbasolutions.flask.model.Event")));

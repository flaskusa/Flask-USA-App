...
/**
 * Provides the local service interface for VenueDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashutosh Rai
 * @see VenueDetailLocalServiceUtil
...
public interface VenueDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VenueDetailLocalServiceUtil} to access the venue detail local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.VenueDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

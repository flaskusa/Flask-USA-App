...
/**
 * Provides the local service interface for EventType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashutosh Rai
 * @see EventTypeLocalServiceUtil
...
public interface EventTypeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventTypeLocalServiceUtil} to access the event type local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.EventTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the local service interface for EventSubDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashutosh Rai
 * @see EventSubDetailLocalServiceUtil
...
public interface EventSubDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventSubDetailLocalServiceUtil} to access the event sub detail local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.EventSubDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

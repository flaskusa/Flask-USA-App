...
/**
 * Provides the local service interface for EventDetailImage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashutosh Rai
 * @see EventDetailImageLocalServiceUtil
...
public interface EventDetailImageLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventDetailImageLocalServiceUtil} to access the event detail image local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.EventDetailImageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.rumbasolutions.flask.model.EventDetailImageEventDetailImageDataBlobModel getEventDetailImageDataBlobModel(

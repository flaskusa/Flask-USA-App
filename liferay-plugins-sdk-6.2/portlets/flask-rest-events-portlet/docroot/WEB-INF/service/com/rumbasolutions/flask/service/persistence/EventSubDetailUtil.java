...
/**
 * The persistence utility for the event sub detail service. This utility wraps {@link EventSubDetailPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class EventSubDetailUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(EventSubDetail eventSubDetail) {
		getPersistence().clearCache(eventSubDetail);
	}
	 ...
	 */
	public static List<EventSubDetail> findWithDynamicQuery(
	 ...
	 */
	public static EventSubDetail update(EventSubDetail eventSubDetail)
		throws SystemException {
		return getPersistence().update(eventSubDetail);
	}
	...
	public static EventSubDetail update(EventSubDetail eventSubDetail,
		...
		return getPersistence().update(eventSubDetail, serviceContext);
	}
	...
	*/
	public static java.util.List<com.rumbasolutions.flask.model.EventSubDetail> findByEventDetailId(
		long eventDetailId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail findByEventDetailId_First(
		long eventDetailId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail fetchByEventDetailId_First(
		long eventDetailId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail findByEventDetailId_Last(
		long eventDetailId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rumbasolutions.flask.NoSuchEventSubDetailException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail fetchByEventDetailId_Last(
		long eventDetailId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail[] findByEventDetailId_PrevAndNext(
		long eventSubDetailId, long eventDetailId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rumbasolutions.flask.NoSuchEventSubDetailException {
		return getPersistence()
				   .findByEventDetailId_PrevAndNext(eventSubDetailId,
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(eventSubDetail);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(eventSubDetails);
	}
	...
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail create(
		long eventSubDetailId) {
		return getPersistence().create(eventSubDetailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail remove(
		long eventSubDetailId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rumbasolutions.flask.NoSuchEventSubDetailException {
		return getPersistence().remove(eventSubDetailId);
	}

	public static com.rumbasolutions.flask.model.EventSubDetail updateImpl(
		com.rumbasolutions.flask.model.EventSubDetail eventSubDetail)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(eventSubDetail);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail findByPrimaryKey(
		long eventSubDetailId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rumbasolutions.flask.NoSuchEventSubDetailException {
		return getPersistence().findByPrimaryKey(eventSubDetailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventSubDetail fetchByPrimaryKey(
		long eventSubDetailId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(eventSubDetailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rumbasolutions.flask.model.EventSubDetail> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EventSubDetailPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EventSubDetailPersistence)PortletBeanLocatorUtil.locate(com.rumbasolutions.flask.service.ClpSerializer.getServletContextName(),
					EventSubDetailPersistence.class.getName());

			ReferenceRegistry.registerReference(EventSubDetailUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(EventSubDetailPersistence persistence) {
	}

	private static EventSubDetailPersistence _persistence;
}
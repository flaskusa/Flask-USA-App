	...
	public void setInfoShortDesc(String infoShortDesc) {
		...
		if (_eventDetailRemoteModel != null) {
			try {
				...
				method.invoke(_eventDetailRemoteModel, infoShortDesc);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMobileAppName(String mobileAppName) {
		...
		if (_eventDetailRemoteModel != null) {
			try {
				...
				method.invoke(_eventDetailRemoteModel, mobileAppName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPremiumDisplayEnabled(boolean premiumDisplayEnabled) {
		...
		if (_eventDetailRemoteModel != null) {
			try {
				...
				method.invoke(_eventDetailRemoteModel, premiumDisplayEnabled);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}

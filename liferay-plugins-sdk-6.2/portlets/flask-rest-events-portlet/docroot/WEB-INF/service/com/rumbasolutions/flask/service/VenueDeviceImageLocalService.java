...
/**
 * Provides the local service interface for VenueDeviceImage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashutosh Rai
 * @see VenueDeviceImageLocalServiceUtil
...
public interface VenueDeviceImageLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VenueDeviceImageLocalServiceUtil} to access the venue device image local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.VenueDeviceImageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the local service interface for InfoType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashutosh Rai
 * @see InfoTypeLocalServiceUtil
...
public interface InfoTypeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InfoTypeLocalServiceUtil} to access the info type local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.InfoTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

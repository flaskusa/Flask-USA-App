...
/**
 * Provides the local service utility for EventDetailImage. This utility wraps
 * {@link com.rumbasolutions.flask.service.impl.EventDetailImageLocalServiceImpl} and is the
 ...
 * @see com.rumbasolutions.flask.service.base.EventDetailImageLocalServiceBaseImpl
 * @see com.rumbasolutions.flask.service.impl.EventDetailImageLocalServiceImpl
 * @generated
 */
public class EventDetailImageLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.EventDetailImageLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.rumbasolutions.flask.model.EventDetailImage addEventDetailImage(
		...
		return getService().addEventDetailImage(eventDetailImage);
	}
	...
	*/
	public static com.rumbasolutions.flask.model.EventDetailImage createEventDetailImage(
		long eventDetailImageId) {
		return getService().createEventDetailImage(eventDetailImageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rumbasolutions.flask.model.EventDetailImage deleteEventDetailImage(
		long eventDetailImageId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteEventDetailImage(eventDetailImageId);
	}
	...
	*/
	public static com.rumbasolutions.flask.model.EventDetailImage deleteEventDetailImage(
		com.rumbasolutions.flask.model.EventDetailImage eventDetailImage)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteEventDetailImage(eventDetailImage);
	}
	...
	*/
	...
	public static com.rumbasolutions.flask.model.EventDetailImage fetchEventDetailImage(
		long eventDetailImageId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchEventDetailImage(eventDetailImageId);
	}
	...
	*/
	public static com.rumbasolutions.flask.model.EventDetailImage getEventDetailImage(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventDetailImage(eventDetailImageId);
	}
	...
	*/
	public static java.util.List<com.rumbasolutions.flask.model.EventDetailImage> getEventDetailImages(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventDetailImages(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getEventDetailImagesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventDetailImagesCount();
	}
	...
	*/
	...
	public static EventDetailImageLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					EventDetailImageLocalService.class.getName());

			if (invokableLocalService instanceof EventDetailImageLocalService) {
				_service = (EventDetailImageLocalService)invokableLocalService;
			}
			else {
				_service = new EventDetailImageLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(EventDetailImageLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(EventDetailImageLocalService service) {
	}

	private static EventDetailImageLocalService _service;
}
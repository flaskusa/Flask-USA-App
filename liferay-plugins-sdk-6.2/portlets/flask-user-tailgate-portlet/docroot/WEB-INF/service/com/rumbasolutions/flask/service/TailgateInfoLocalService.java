...
/**
 * Provides the local service interface for TailgateInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TailgateInfoLocalServiceUtil
...
public interface TailgateInfoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TailgateInfoLocalServiceUtil} to access the tailgate info local service. Add custom service methods to {@link com.rumbasolutions.flask.service.impl.TailgateInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
public abstract class TailgateUsersActionableDynamicQuery
	...
	public TailgateUsersActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TailgateUsersLocalServiceUtil.getService());
		setClass(TailgateUsers.class);

		setClassLoader(com.rumbasolutions.flask.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("tailgateUserId");
	}
}
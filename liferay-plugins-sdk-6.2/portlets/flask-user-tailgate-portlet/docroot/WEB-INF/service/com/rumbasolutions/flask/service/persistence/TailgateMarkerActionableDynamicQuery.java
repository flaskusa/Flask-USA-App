...
public abstract class TailgateMarkerActionableDynamicQuery
	...
	public TailgateMarkerActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TailgateMarkerLocalServiceUtil.getService());
		setClass(TailgateMarker.class);

		setClassLoader(com.rumbasolutions.flask.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("tailgatemarkerid");
	}
}
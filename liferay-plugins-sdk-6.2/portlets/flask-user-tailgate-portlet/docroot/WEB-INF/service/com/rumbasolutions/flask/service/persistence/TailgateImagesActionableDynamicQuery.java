...
public abstract class TailgateImagesActionableDynamicQuery
	...
	public TailgateImagesActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TailgateImagesLocalServiceUtil.getService());
		setClass(TailgateImages.class);

		setClassLoader(com.rumbasolutions.flask.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("tailgateImageId");
	}
}
...
import com.rumbasolutions.flask.service.TailgateMarkerLocalService;
...
/**
 * Provides the base implementation for the tailgate marker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rumbasolutions.flask.service.impl.TailgateMarkerLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TailgateMarkerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TailgateMarkerLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rumbasolutions.flask.service.TailgateMarkerLocalServiceUtil} to access the tailgate marker local service.
	 */
	...
	@Override
	public TailgateMarker addTailgateMarker(TailgateMarker tailgateMarker)
		throws SystemException {
		tailgateMarker.setNew(true);

		return tailgateMarkerPersistence.update(tailgateMarker);
	}
	 ...
	 */
	@Override
	public TailgateMarker createTailgateMarker(long tailgatemarkerid) {
		return tailgateMarkerPersistence.create(tailgatemarkerid);
	}
	...
	@Override
	public TailgateMarker deleteTailgateMarker(long tailgatemarkerid)
		throws PortalException, SystemException {
		return tailgateMarkerPersistence.remove(tailgatemarkerid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TailgateMarker deleteTailgateMarker(TailgateMarker tailgateMarker)
		throws SystemException {
		return tailgateMarkerPersistence.remove(tailgateMarker);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TailgateMarker.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tailgateMarkerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tailgateMarkerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TailgateMarker fetchTailgateMarker(long tailgatemarkerid)
		throws SystemException {
		return tailgateMarkerPersistence.fetchByPrimaryKey(tailgatemarkerid);
	}
	 ...
	 */
	@Override
	public TailgateMarker getTailgateMarker(long tailgatemarkerid)
		throws PortalException, SystemException {
		return tailgateMarkerPersistence.findByPrimaryKey(tailgatemarkerid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tailgateMarkerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TailgateMarker> getTailgateMarkers(int start, int end)
		throws SystemException {
		return tailgateMarkerPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTailgateMarkersCount() throws SystemException {
		return tailgateMarkerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TailgateMarker updateTailgateMarker(TailgateMarker tailgateMarker)
		throws SystemException {
		return tailgateMarkerPersistence.update(tailgateMarker);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rumbasolutions.flask.model.TailgateMarker",
			tailgateMarkerLocalService);
	}
	...
	private TailgateMarkerLocalServiceClpInvoker _clpInvoker = new TailgateMarkerLocalServiceClpInvoker();
}
...
function initialize(portletId, portlet){
	if(portletId == "flaskmanageregularusers_WAR_flaskmanageregularusersportlet") {
		$("#adminForm").hide();
		createTable({},_userModel.DATA_MODEL.USER, $('#grid'), "actionMenu", "Edit", contextMenuHandler, ["User", "Images"]);
		loadData();
		addClickHandlers();
